import '../category_grid_view_screen/widgets/product1_item_widget.dart';
      ...
      child: Row(
        ...
        children: [
          ...
          CustomDropDown(
            ...
            hintText: "lbl_new".tr,
            items: controller
                .categoryGridViewModelObj.value.dropdownItemList!.value,
            onChanged: (value) {
        ...
        child: Obx(
          () => Wrap(
            ...
            children: List<Widget>.generate(
              controller
                  .categoryGridViewModelObj.value.selectItemList.value.length,
              (index) {
                SelectItemModel model = controller
                    .categoryGridViewModelObj.value.selectItemList.value[index];
      ...
      child: Obx(
        () => GridView.builder(
          ...
          itemCount: controller
              .categoryGridViewModelObj.value.product1ItemList.value.length,
          itemBuilder: (context, index) {
            Product1ItemModel model = controller
                .categoryGridViewModelObj.value.product1ItemList.value[index];
            return Product1ItemWidget(
              model,
            );
          },
        ),
