  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Obx(
          () => CustomImageView(
            imagePath: productlistItemModelObj.userImage!.value,
            height: 133.v,
            width: 100.h,
          ),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  productlistItemModelObj.description!.value,
              ...
              Row(
                children: [
                  Obx(
                    () => CustomImageView(
                      imagePath: productlistItemModelObj.ratingImage!.value,
                      height: 13.adaptSize,
                      width: 13.adaptSize,
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        productlistItemModelObj.ratingText!.value,
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          productlistItemModelObj.sizeLabel!.value,
                          style: theme.textTheme.bodySmall,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      child: Obx(
                        () => Text(
                          productlistItemModelObj.sizeS!.value,
                    ...
                    Container(
                      ...
                      child: Obx(
                        () => Text(
                          productlistItemModelObj.sizeM!.value,
                          style: CustomTextStyles.bodySmall10,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      child: Obx(
                        () => Text(
                          productlistItemModelObj.sizeL!.value,
                          style: CustomTextStyles.bodySmall10,
                        ),
                      ),
                    ),
