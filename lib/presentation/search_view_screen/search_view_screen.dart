      ...
      child: Row(
        ...
        children: [
          ...
          CustomDropDown(
            ...
            hintText: "lbl_new".tr,
            items: controller.searchViewModelObj.value.dropdownItemList!.value,
            onChanged: (value) {
      ...
      child: Obx(
        () => GridView.builder(
          ...
          itemCount: controller
              .searchViewModelObj.value.productgridItemList.value.length,
          itemBuilder: (context, index) {
            ProductgridItemModel model = controller
                .searchViewModelObj.value.productgridItemList.value[index];
